...
export abstract class BaseEntity {
  ...
  @CreateDateColumn({ type: 'datetime', name: 'create_time', default: () => 'CURRENT_TIMESTAMP', comment: '创建时间' })
  ...
  @UpdateDateColumn({ type: 'datetime', name: 'update_time', default: () => 'CURRENT_TIMESTAMP', comment: '更新时间' })
